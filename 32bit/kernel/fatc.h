...
static char BPB[90]; // BIOS Parameter Block
static char fat[512]; // FAT sector cache, supports 512 byte sectors
...
static void kstrcpy(const char*, char*);
static int read_root_file(const char*, int is_dir);
static char ktoupper(char);
